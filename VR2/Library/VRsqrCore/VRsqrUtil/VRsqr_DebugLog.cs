...
// implementation taken from here: https://answers.unity.com/questions/126315/debuglog-in-build.html
...
namespace VRsqrUtil
{
    ...
    {
        public static LogLevel maxLogLevel = LogLevel.None;
        ...
        public static void Log(LogLevel logLevel, object message, UnityEngine.Object context = null)
        {
            ...
            {
                if (messageFilter == "" ||
                    message.ToString().Contains(messageFilter))
                {
                    ...
                    {
                        UnityEngine.Debug.Log(logLevel.ToString() + ": " + message, context);
                    }
                }
            }
        }
